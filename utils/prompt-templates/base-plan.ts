...
export function buildBasePlanPrompts(
  ...
  "days": {
    ...
    "tuesday": {"workout": {"focus": ["Lower Body"], "blocks": [{"name": "Main", "items": [{"exercise": "Exercise B", "sets": 3, "reps": "8-12", "RIR": 2}]}]}, "nutrition": {"total_kcal": ${calorieTarget}, "protein_g": ${proteinTarget}, "meals": [{"name": "Meal 1", "items": [{"food": "Food", "qty": "Amount"}]}], "hydration_l": 3.5}, "recovery": {"mobility": ["Mobility"], "sleep": ["Sleep"]}, "reason": "Expert rationale"},
    "wednesday": {"workout": {"focus": ["Full Body"] , "blocks": [{"name": "Main", "items": [{"exercise": "Exercise C", "sets": 3, "reps": "8-12", "RIR": 2}]}]}, "nutrition": {"total_kcal": ${calorieTarget}, "protein_g": ${proteinTarget}, "meals": [{"name": "Meal 1", "items": [{"food": "Food", "qty": "Amount"}]}], "hydration_l": 3.5}, "recovery": {"mobility": ["Mobility"], "sleep": ["Sleep"]}, "reason": "Expert rationale"},
    "thursday": {"workout": {"focus": ["Upper Pull"], "blocks": [{"name": "Main", "items": [{"exercise": "Exercise D", "sets": 3, "reps": "8-12", "RIR": 2}]}]}, "nutrition": {"total_kcal": ${calorieTarget}, "protein_g": ${proteinTarget}, "meals": [{"name": "Meal 1", "items": [{"food": "Food", "qty": "Amount"}]}], "hydration_l": 3.5}, "recovery": {"mobility": ["Mobility"], "sleep": ["Sleep"]}, "reason": "Expert rationale"},
    "friday": {"workout": {"focus": ["Lower Body"], "blocks": [{"name": "Main", "items": [{"exercise": "Exercise E", "sets": 3, "reps": "8-12", "RIR": 2}]}]}, "nutrition": {"total_kcal": ${calorieTarget}, "protein_g": ${proteinTarget}, "meals": [{"name": "Meal 1", "items": [{"food": "Food", "qty": "Amount"}]}], "hydration_l": 3.5}, "recovery": {"mobility": ["Mobility"], "sleep": ["Sleep"]}, "reason": "Expert rationale"},
    "saturday": {"workout": {"focus": ["Conditioning"], "blocks": [{"name": "Metcon", "items": [{"exercise": "Circuit", "sets": 1, "reps": "15-20 min", "RIR": 0}]}]}, "nutrition": {"total_kcal": ${calorieTarget}, "protein_g": ${proteinTarget}, "meals": [{"name": "Meal 1", "items": [{"food": "Food", "qty": "Amount"}]}], "hydration_l": 3.5}, "recovery": {"mobility": ["Mobility"], "sleep": ["Sleep"]}, "reason": "Expert rationale"},
    "sunday": {"workout": {"focus": ["Recovery"], "blocks": [{"name": "Active Recovery", "items": [{"exercise": "Walk/Yoga", "sets": 1, "reps": "20-30 min", "RIR": 0}]}]}, "nutrition": {"total_kcal": ${calorieTarget}, "protein_g": ${proteinTarget}, "meals": [{"name": "Meal 1", "items": [{"food": "Food", "qty": "Amount"}]}], "hydration_l": 3.5}, "recovery": {"mobility": ["Mobility"], "sleep": ["Sleep"]}, "reason": "Expert rationale"}
  }
}`;
