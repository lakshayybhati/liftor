...
module.exports = ({ config }) => {
  return {
    ...
    extra: {
      ...
      EXPO_PUBLIC_REVENUECAT_IOS_API_KEY: process.env.EXPO_PUBLIC_REVENUECAT_IOS_API_KEY || config.extra?.EXPO_PUBLIC_REVENUECAT_IOS_API_KEY,
      EXPO_PUBLIC_REVENUECAT_ANDROID_API_KEY: process.env.EXPO_PUBLIC_REVENUECAT_ANDROID_API_KEY || config.extra?.EXPO_PUBLIC_REVENUECAT_ANDROID_API_KEY,
